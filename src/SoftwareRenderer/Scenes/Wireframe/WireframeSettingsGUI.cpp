...
WireframeSettingsGUI::WireframeSettingsGUI(Configuration* configuration) : m_pConfiguration(configuration), SceneSettingsGUI("Wireframe Settings"), m_bEnableCulling(false),
...
void WireframeSettingsGUI::Render()
{
...
void WireframeSettingsGUI::SetModelsList(const std::vector<std::string>& filesList)
{
  m_ModelsList = filesList;
}

float WireframeSettingsGUI::GetXRotationAngleSpeed() const
{
  return m_xRotationAngleSpeed;
}

float WireframeSettingsGUI::GetYRotationAngleSpeed() const
{
  return m_yRotationAngleSpeed;
}

float WireframeSettingsGUI::GetZRotationAngleSpeed() const
{
  return m_zRotationAngleSpeed;
}

bool WireframeSettingsGUI::IsCullingEnabled() const
{
  return m_bEnableCulling;
}

bool WireframeSettingsGUI::IsResetRotation()
{
...
std::string WireframeSettingsGUI::GetSelectedModel()
{
  return m_sSelectedModel;
}

void WireframeSettingsGUI::ShowModelsListSelector()
{
...
void WireframeSettingsGUI::SetSelectedModel(const std::string& fileName)
{
